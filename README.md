...
- **多語翻譯目標 + 多語介面**（v1.8.59 起，v1.8.62 全部到位）：可選翻譯成 8 種語言（繁體中文 / 簡體中文 / 英文 / 日文 / 韓文 / 西班牙文 / 法文 / 德文）。設定頁「翻譯目標語言」分頁切換，所有翻譯模式（網頁 / PDF / YouTube 字幕）共用此設定；popup / 設定頁 / 網頁翻譯進度通知同樣支援 8 語介面，可獨立設定或跟著瀏覽器語言推導（PDF 文件翻譯 reader 介面暫仍為繁中）
...
v1.8.64 — 完整功能清單與規格詳見 [SPEC.md](SPEC.md)。
